...
def test_streamlit_pages_have_unique_url_paths_and_meet_setup_default():
    ...
    assert url_paths == ["meet-dashboard", "meet-setup", "athletes", "athlete-profile", "team-progress", "configure-race", "live-timing", "results", "school-branding", "live-race", "coach-sign-in"]
