...
def initialize_state(session_state) -> None:
    ...
    session_state.setdefault("pack_unsynced_count", 0)
    session_state.setdefault("pack_synced_count", 0)
    session_state.setdefault("pack_browser_online", None)
    session_state.setdefault("timer_station_change_requested", False)
    session_state.setdefault("pending_timer_assignment", None)
    session_state.setdefault("race_day_station_intent", "checkpoint")
